...
<form action="Process" method="get">
			...
			<table>
								...
								GENRE
													...
													<c:forEach items="${display}" var="entries1">
...
Arun Prakash <br>
Darshan Shah <br>
Shashikanth Ragula <br>
Sai Siddharth <br>
Tulsi Raisoni <br>
<!--  <a onclick="document.getElementById('div_about_us').style.display='none';return false;" href="" style="text-decoration:none;border-bottom:1px dotted blue;"><input type="submit" value="Back"></a>
	-->
</div>
